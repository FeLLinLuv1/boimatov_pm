...
{
    public partial class specialitet : Form
    {
        ...
        {
            string query = "SELECT name FROM napravlen WHERE uroven_id = 3";
        ...
        private void ready_but_Click(object sender, EventArgs e)
        {
            ...
            string insertQuery = "INSERT INTO specialitet (napr_id, client_id, ege, date_pod, document_pdf, status, coments) " +
